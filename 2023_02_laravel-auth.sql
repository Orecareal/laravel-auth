...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2586493230ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2023_02_laravel-auth&table=users">`2023_02_laravel-auth`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2023_02_crud_laravel_ajax&table=students">`2023_02_crud_laravel_ajax`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2023_02_crud_laravel_ajax&table=table_students">`2023_02_crud_laravel_ajax`.`table_students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=2023_02_crud_laravel_ajax&table=users">`2023_02_crud_laravel_ajax`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4_klinik&table=dokter">`ci4_klinik`.`dokter`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4_klinik&table=users">`ci4_klinik`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4_login&table=users">`ci4_login`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4_klinik&table=berobat">`ci4_klinik`.`berobat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4_article&table=news">`ci4_article`.`news`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci4-rekam-medis&table=berobat">`ci4-rekam-medis`.`berobat`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="254b21475f7925465642696b5624367c">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="2023_02_laravel-auth" targettable="">
            ...
            Database
                            : <span>2023_02_laravel-auth</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `failed_jobs`, `migrations`, `password_resets`, `personal_access_tokens`, `users`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="2023_02_laravel-auth" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="2023_02_laravel-auth" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
